...
class AuthenticationDataProvider {
  ...
  Future<ApiResponse<LoginResponse?>> loginAPI({required String username, required String password}) async {
    try {
      final res = await _apiService.post('/login', data: {'username': username, 'password': password});
