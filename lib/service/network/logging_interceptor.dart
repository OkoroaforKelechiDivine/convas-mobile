...
import 'package:safe_chat/utilities/logger/logger.dart';
...
class LoggingInterceptor extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    if (kDebugMode) {
      Console.log('==>', '<== REQUEST ==>');
      Console.log('REQUEST[${options.method}]', '==> ${options.uri.toString()}');
  ...
  void onResponse(Response response, ResponseInterceptorHandler handler) {
    if (kDebugMode) {
      ...
      Console.log('RESPONSE[${response.statusCode}]', '=> PATH: ${response.requestOptions.uri.toString()}');
